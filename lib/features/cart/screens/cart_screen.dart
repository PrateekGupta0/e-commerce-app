        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: CustomButton(text: 'Proceed to Buy (${user.cart.length}) items', onTap: (){navigateToAddress(sum);},color: Colors.yellow[600],),
            ...
            ListView.builder(
                shrinkWrap:true, itemCount: user.cart.length,itemBuilder: (context,index) {
